...
* The design should allow users to specify a regular topology and irregular geometry in the IDF, and create detector panels from that definition. This would be somewhat analygous to a [vtkStructuredGrid](http://www.vtk.org/doc/nightly/html/classvtkStructuredGrid.html)
