...
\item The framework is developed by a core group of developers using professional software development practices
...
\textbf{This section is being written by A. Hillier}
...
\\
EventWorkpsace&eventlist	&adaptive mesh rebin  &\pbox{20cm}{ correlated sample log \\spectrum number detector ID}&raw event data	\\
\\	
\pbox{20cm}{Multidimensional\\ workspace} &\pbox{20cm}{ $n$ eventlist\\$n$ histogram}& adaptive mesh rebin& $n$dim axis units& processed volume data sets\\
\\
...
\textbf{something more is required here}
...
These are presented to the user through a GUI layer and often a "super algorithm" 
...
\item brag peaks can be selected and saved a table workspaces
...
The MantidPlot application can be used to submit bug reports, requests for assistance and viewing of the online and offline help files.
